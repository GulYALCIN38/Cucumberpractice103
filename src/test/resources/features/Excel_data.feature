...
Feature: Excel_Ulkeler
  ...
  Scenario: Ulkeler
    Given 1 inci satirdaki 1 inci hucreye gidelim ve yazdiralim
    Then  baskenti "Berlin" olan ulke ismini yazdiralim
    And   kullanici ulke sayisini yazdirir
    And   kullanici fiziki olarak kullanilan satir sayisini bulur
    And   kullanici baskenti "Genk" olan ulkenin tum bilgilerini yazdirir
